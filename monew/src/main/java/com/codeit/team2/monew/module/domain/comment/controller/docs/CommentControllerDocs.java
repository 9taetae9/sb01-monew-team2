...
public interface CommentControllerDocs {
    ...
    @PostMapping
    ResponseEntity<CommentDto> register(CommentRegisterRequest request, UUID userId);
    ...
    ResponseEntity<CommentDto> update(UUID commentId, UUID userId, CommentUpdateRequest request);
    ...
    ResponseEntity<Void> delete(UUID commentId, UUID userId);
